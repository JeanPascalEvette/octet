    ...
    */
    class System
    {
      ...
      public:
        ...
        // Setup functions.
        FMOD_RESULT F_API setOutput               (FMOD_OUTPUTTYPE myOutput);
        FMOD_RESULT F_API getOutput               (FMOD_OUTPUTTYPE *myOutput);
    ...
    */
    class DSP
    {
      ...
      public:
        ...
        FMOD_RESULT F_API getOutput              (int index, DSP **myOutput, DSPConnection **outputconnection);
    ...
    */
    class DSPConnection
    {
      ...
      public:
        ...
        FMOD_RESULT F_API getOutput             (DSP **myOutput);
